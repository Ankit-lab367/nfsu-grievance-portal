...
export default function Navbar() {
    ...
    return (
        ...
        <nav className="glass-theme border-b border-slate-200 dark:border-white/10 sticky top-0 z-40 transition-colors duration-300">
                                    ...
                                    {showMoreMenu && (
                                        ...
                                        >
                                            ...
                                            <button
                                                ...
                                                className="w-full flex items-center space-x-3 px-4 py-3 text-gray-300 hover:bg-white/10 hover:text-white transition-colors border-t border-white/5"
                                            >
                                                <FaBook className="text-orange-400 text-sm" />
                                                <span className="text-sm font-medium">Academic Section</span>
                                            </button>
                                        </motion.div>
                                    )}
                                </AnimatePresence>
                    ...
                    >
                        <div className="px-6 py-4 flex flex-col space-y-4">
                            ...
                            <div className="pt-4 border-t border-white/5 space-y-4">
                                ...
                                >
                                    <FaBook className="text-orange-400 text-sm" /><span>Academic Section</span>
                                </button>
                                <button
                                    onClick={() => {
                                        handleForenSyncJump();
