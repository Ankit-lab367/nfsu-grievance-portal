    ...
    const fetchComplaints = async (token) => {
        try {
            ...
            if (response.data.success) {
                // Filter for student complaints only
                ...
                >
                    <div>
                        ...
                        <p className="text-gray-300 font-medium">
                            {user?.enrollmentNumber ? `Enrollment: ${user.enrollmentNumber}` : 'Student Portal'}
                        </p>
                    </div>
                    <div className="flex flex-wrap items-center gap-3">
                        ...
                        <Link
                            ...
                            className="relative flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-xl font-bold shadow-lg hover:shadow-blue-500/30 transition-all active:scale-95"
                        >
                            <FaBell />
                            <span>Notices</span>
                            {hasNotices && (
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                    ...
                    >
                        <div className="flex items-center space-x-4">
                            <div className="p-4 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg text-white group-hover:scale-110 transition-transform">
                        ...
                        <div className="space-y-4">
                            {complaints.filter(c => c.status !== 'Resolved').slice(0, 5).map((complaint) => (
                                <div
                                    ...
                                    className="block bg-white/5 hover:bg-white/10 rounded-lg p-4 transition-all border border-white/10 hover:border-blue-400/50 cursor-pointer group"
                                >
                                    <div className="flex items-center justify-between">
                                        <div className="flex-1">
                                            <div className="flex items-center justify-between">
                                                <span
                                                    className="text-slate-900 dark:text-white font-semibold group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors text-lg"
                                                >
                                                    {complaint.title}
                                                </span>
