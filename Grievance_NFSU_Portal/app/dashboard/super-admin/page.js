                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="p-4 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg text-white shadow-lg shadow-blue-500/20">
                ...
                <div className="glass-card-theme p-6 border-slate-200 dark:border-white/10 shadow-xl">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {departments.map((dept) => (
                            <div
                                key={dept._id}
                                className="bg-slate-900/5 dark:bg-white/5 rounded-xl p-6 border border-slate-200 dark:border-white/10 shadow-sm transition-all hover:border-blue-500/50"
                            >
