...
export default function AcademicManager() {
    ...
    useEffect(() => {
        // Fetch all resources (reuse the get API but potentially without filters to get all, 
        // or we need to update the GET API to handle no filters if it doesn't already.
        // Looking at the GET API implementation:
        // const query = {}; if (degree) ... 
        // So if we pass no params, it returns all. Perfect.
        fetchResources();

        // Simulate a short "scanning" effect
    ...
    return (
        <div className="min-h-screen bg-black font-mono text-[#00ff00] p-6">
            <style jsx global>{`
                body {
                ...
                <div className="flex items-center justify-between mb-8 border-b border-[#00ff00]/30 pb-4">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-[#00ff00]/60 tracking-widest">GOD MODE ACCESS // LEVEL 7</p>
                        </div>
                    </div>
