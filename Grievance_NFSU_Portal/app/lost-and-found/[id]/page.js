                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    {item ? (
                        <motion.div
                            ...
                            className="glass-card-theme p-0 overflow-hidden border-slate-200 dark:border-white/10 shadow-2xl"
                        >
                            {/* 1. Subject */}
                            ...
                            {/* 2. Image */}
                            <div className="relative w-full h-[400px] bg-slate-100 dark:bg-white/5 overflow-hidden">
                                {item.image ? (
                                    <img
                                        src={item.image}
                                        alt={item.subject}
                            ...
                            <div className="p-8 space-y-8">
                                ...
                                <div className="pt-8 border-t border-slate-100 dark:border-white/5 flex flex-wrap gap-4">
                                    <motion.button
                                        ...
                                        className="flex items-center gap-3 px-8 py-4 bg-slate-900 dark:bg-white/10 text-white rounded-2xl shadow-xl hover:bg-blue-600 dark:hover:bg-blue-500 transition-all font-bold"
                                    >
                            ...
                            <form onSubmit={handleSendComment} className="p-6 border-t border-white/10 bg-white/5">
                                <div className="flex items-center space-x-3">
                                    <input
                                        ...
                                        className="flex-1 bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all text-shadow-sm"
                                    />
                                    <button
                                        type="submit"
