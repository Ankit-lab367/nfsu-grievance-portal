        ...
        <div className="min-h-screen relative bg-slate-50 dark:bg-[#0f172a] transition-colors duration-500">
            ...
            <div className="container mx-auto px-6 py-8">
                <div className="max-w-4xl mx-auto">
                    <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-8">Track Your Complaint</h1>

                    {/* Search Box */}
                    <div className="glass-card-theme p-8 mb-8 border-slate-200 dark:border-white/10 shadow-xl relative overflow-hidden">
                            ...
                            <div>
                                ...
                                <div className="flex space-x-4">
                                    <input
                                        ...
                                        className="flex-1 px-4 py-3 bg-white/5 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all font-medium"
                                    />
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-blue-500/50 transition-all disabled:opacity-50 flex items-center"
                                    >
                                        {loading ? (
                    ...
                    {complaint && (
                        <div className="space-y-6">
                            {/* Header */}
                            <div className="glass-card-theme p-6 border-slate-200 dark:border-white/10 shadow-lg">
                                <div className="flex items-start justify-between mb-4">
                                    <div>
                                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">{complaint.title}</h2>
                            ...
                            <div className="glass-card-theme p-6 border-slate-200 dark:border-white/10 shadow-lg">
                                ...
                                <p className="text-slate-700 dark:text-gray-300 leading-relaxed">{complaint.description}</p>
                                ...
                                <div className="space-y-6">
                                    {complaint.timeline?.map((entry, index) => (
                                        <div key={index} className="relative pl-8 timeline-item">
                                            <div className="absolute left-0 top-0 w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-sm font-bold border-4 border-slate-900">
                                                {index + 1}
                                            </div>
                            ...
                            {complaint.status === 'Resolved' && complaint.resolutionDetails && (
                                <div className="glass-card-theme p-6 border-slate-200 dark:border-white/10 shadow-lg border-2 border-green-500/50">
