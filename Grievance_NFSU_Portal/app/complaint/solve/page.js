    ...
    const fetchInProgressComplaints = async (token) => {
        try {
            ...
            if (response.data.success) {
                // Filter only in-progress complaints for solving
                    ...
                    <AnimatePresence mode="wait">
                        {loading ? (
                            ...
                            >
                                ...
                                <Link
                                    href="/dashboard/admin"
                                    className="inline-block mt-8 px-8 py-3 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl transition-all active:scale-95 shadow-lg shadow-blue-500/20"
                                >
                                    Go to Pending Tasks
                                </Link>
                            </motion.div>
                                    ...
                                    >
                                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                            <div className="flex-1">
                                                ...
                                                <h2 className="text-xl font-bold text-slate-900 dark:text-white group-hover:text-blue-500 transition-colors mb-2">
                                                    {complaint.title}
                                                </h2>
                                            ...
                                            <button
                                                ...
                                                className="px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-bold rounded-2xl shadow-lg hover:shadow-blue-500/30 transition-all active:scale-95 flex items-center justify-center gap-2 group/btn"
                                            >
