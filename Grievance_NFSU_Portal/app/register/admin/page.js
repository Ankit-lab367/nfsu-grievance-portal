            ...
            <div className="relative z-10 w-full max-w-2xl px-6">
                <div className="glass-card-theme p-8 md:p-10 border border-slate-200 dark:border-white/10 shadow-2xl">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Admin Registration</h1>
                        <p className="text-slate-600 dark:text-gray-300 font-medium">Create an Administrative Account</p>
                    </div>
