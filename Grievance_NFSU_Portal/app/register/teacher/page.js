    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                ...
                // Redirect to a dashboard or home since teacher dashboard might not exist yet
                router.push('/');
            }
        } catch (err) {
                ...
                <div className="glass-card-theme p-8 md:p-10 border border-slate-200 dark:border-white/10 shadow-2xl">
                    <div className="text-center mb-8">
                        <div className="relative inline-block mb-4">
                            ...
                            />
                            <div className="absolute -bottom-2 -right-2 bg-green-600 p-2 rounded-lg text-white shadow-lg">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        required
                                        className="w-full pl-12 pr-4 py-3 bg-slate-900/5 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 transition-all font-medium"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-green-500/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                        >
                            {loading ? (
                                <>
                    ...
                    <div className="mt-8 text-center border-t border-slate-200 dark:border-white/10 pt-6">
                        ...
                        <Link href="/register-selection" className="block mt-4 text-slate-500 dark:text-gray-400 hover:text-green-500 dark:hover:text-green-400 transition-colors font-semibold">
