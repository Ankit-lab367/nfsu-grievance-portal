        ...
        <div className="min-h-screen relative overflow-hidden flex items-center justify-center bg-slate-50 dark:bg-[#0f172a] transition-colors duration-500">
            ...
            <div className="relative z-10 w-full max-w-4xl px-6">
                ...
                >
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-4">Choose Your Role</h1>
                    <p className="text-slate-600 dark:text-gray-300 text-lg font-medium">Select the type of account you want to create</p>
                </motion.div>
                    ...
                    {roles.map((role, index) => (
                        ...
                        >
                            <Link href={role.href} className="block group">
                                <div className="glass-card-theme p-10 h-full border border-slate-200 dark:border-white/10 shadow-xl hover:shadow-2xl hover:border-blue-500/50 transition-all cursor-pointer relative overflow-hidden">
                                    ...
                                    <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">{role.title}</h2>
                                    <p className="text-slate-600 dark:text-gray-300 leading-relaxed font-medium">
                                        {role.description}
                                    </p>

                                    <div className="mt-8 flex items-center text-blue-600 dark:text-blue-400 font-bold group-hover:translate-x-2 transition-transform">
                ...
                >
                    <Link href="/" className="inline-flex items-center text-slate-500 dark:text-gray-400 hover:text-blue-500 font-bold transition-colors">
