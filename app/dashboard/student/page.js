        ...
        <div className="min-h-screen relative dark:bg-background-dark transition-colors duration-500">
            ...
            <div className="container mx-auto px-6 py-8 relative z-10">
                ...
                <div className="glass-card-theme p-6">
                    ...
                    {!user?.isVerifiedID ? (
                        <div className="text-center py-12 border-2 border-dashed border-red-500/20 rounded-2xl bg-red-500/5">
                            <div className="w-16 h-16 bg-red-500/10 rounded-full flex items-center justify-center mx-auto mb-4">
                                <FaExclamationCircle className="text-3xl text-red-500 animate-pulse" />
                            </div>
                            <h3 className="text-xl font-bold text-white mb-2">Need to be Verified</h3>
