            ...
            <div className="container mx-auto px-4 py-8 relative z-10">
                <div className="max-w-5xl mx-auto">
                    ...
                    <motion.button
                        ...
                        className="flex items-center space-x-2 text-slate-600 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-400 transition-colors font-bold mb-8 group"
                    >
                        ...
                        >
                            <div className="glass-card-theme p-8 text-center">
                                <div className="relative inline-block mb-6">
                                    ...
                                    <div className="absolute -bottom-2 -right-2 bg-red-600 text-white p-2.5 rounded-2xl shadow-xl">
                                ...
                                <p className="text-red-500 text-sm font-black uppercase tracking-widest mb-6">
                                    Student Profile
                                </p>
                                <div className="space-y-4 text-left">
                                    <div className="flex items-center space-x-4 p-4 bg-slate-900/5 dark:bg-white/5 rounded-2xl border border-slate-200 dark:border-white/5 group hover:border-red-500/30 transition-all">
