                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                        ...
                        >
                            <button
                                ...
                                className="flex items-center space-x-2 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-400 transition-colors font-bold mb-4"
                            >
                                <FaArrowLeft />
                        ...
                        >
                            <div className="relative flex-1 md:w-80">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-4 py-3 bg-white/10 dark:bg-white/5 border border-white/10 rounded-2xl dark:text-white focus:outline-none focus:ring-4 focus:ring-red-500/20 transition-all font-medium"
                                />
                            </div>
                            <button className="p-3 bg-white/10 dark:bg-white/5 border border-white/10 rounded-2xl dark:text-gray-400 hover:text-red-500 transition-all shadow-lg">
                                <FaFilter />
                            </button>
                        </motion.div>
                    </div>
                            ...
                            {filteredApps.length > 0 ? (
                                filteredApps.map((app, index) => (
                                    <motion.div
                                        ...
                                        className="glass-card-theme p-5 hover:bg-white/5 dark:hover:bg-white/5 transition-all cursor-pointer group border-white/10 shadow-md hover:shadow-xl"
                                    >
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center space-x-5">
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-green-500 border-4 border-[#1e293b] rounded-full shadow-lg" title="Active Student" />
                                                </div>
                                                <div>
                                                    <h3 className="text-xl font-bold text-slate-900 dark:text-white group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors mb-1">
