                ...
                <div className="container mx-auto px-6 py-8">
                        ...
                        <>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                                <motion.div
                                    initial={{ opacity: 0, y: 20 }}
                                    animate={{ opacity: 1, y: 0 }}
                                    className="glass-card-theme p-6 border-white/10 shadow-xl"
                                >
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="p-4 bg-gradient-to-r from-red-600 to-red-700 rounded-lg text-white shadow-lg">
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="p-4 bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg text-white shadow-lg">
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="p-4 bg-gradient-to-r from-green-500 to-green-600 rounded-lg text-white shadow-lg">
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-3xl font-bold text-white">{stats.avgResolutionTime}h</p>
                                        </div>
                                        <div className="p-4 bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg text-white shadow-lg">
                                    ...
                                    {stats.complaintsByDepartment?.map((dept, index) => (
                                        ...
                                        >
                                            <div className="flex items-center justify-between mb-2">
                                                <h3 className="text-white font-bold">{dept._id}</h3>
                                                <span className="text-gray-400 text-sm font-bold">{dept.count} complaints</span>
                                            </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-8">
                        <button
                            ...
                            className="glass-card-theme p-6 border-white/10 shadow-xl hover:bg-white/10 transition-all card-hover group text-left"
                        >
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    <h3 className="text-white font-bold text-lg">Create Admin User</h3>
                                    <p className="text-gray-400 text-sm font-medium">Add new department administrator</p>
                                </div>
                            </div>
                        </button>
                        <button
                        ...
                        >
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    <h3 className="text-white font-bold text-lg">Manage Departments</h3>
                                    <p className="text-gray-400 text-sm font-medium">Add or edit departments</p>
                                </div>
                            </div>
                        </button>
                    </div>
                    ...
                    <div className="glass-card-theme p-6 border-white/10 shadow-xl">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {departments.map((dept) => (
                                <div
                                    key={dept._id}
                                    className="bg-white/5 rounded-xl p-6 border border-white/10 shadow-sm transition-all hover:border-red-500/50"
                                >
                                    <h3 className="text-white font-bold mb-2">{dept.name}</h3>
                                    <p className="text-gray-400 text-sm mb-3 font-bold">{dept.email}</p>
                                    <div className="flex items-center justify-between text-xs text-gray-500 font-bold border-t border-white/10 pt-3">
